...
bool {{cookiecutter.app_var_name}}_index_get_private( private_key_t private_key, const uint32_t index )
{
...

    {
        ...
        if( sizeof( private_key_t ) != 32 ) abort();
...
bool {{cookiecutter.app_var_name}}_index_get_private_public_address( private_key_t private_key, public_key_t public_key, char *address,
